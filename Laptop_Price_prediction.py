...
["Dell","Lenovo","HP","Asus","Acer","Apple","MSI","Toshiba","Samsung","Huawei","Microsoft","Xiaomi","Vero","Chuwi","Mediacom","Razer","LG","Google","Fujitsu"])

typename = st.selectbox("Type",
["Notebook","Ultrabook","Gaming","2 in 1 Convertible","Workstation","Netbook"])

inches = st.number_input("Screen Size",10.0,20.0,15.6)
